 ...
 */
public class CrosheSlidingPaneLayout extends SlidingPaneLayout {
    ...
    public CrosheSlidingPaneLayout(Context context) {
        this(context, null);
    }

    public CrosheSlidingPaneLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CrosheSlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
